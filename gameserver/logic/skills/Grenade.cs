...
namespace gameserver.logic.behaviors
{
    public class Grenade : Behavior
    {
        ...
        public Grenade(double radius, int damage, double range = 5,
            double? fixedAngle = null, Cooldown coolDown = new Cooldown(), uint color = 0xFF0000, ConditionEffectIndex effect = ConditionEffectIndex.Nothing, int effectDuration = -1)
        {
                ...
                if (player != null || fixedAngle != null)
                {
                    ...
                    host.Owner.Timers.Add(new WorldTimer(1500, (world, t) =>
                    {
                        ...
                        world.Aoe(target, radius, true, p => {
                            if (effect != ConditionEffectIndex.Nothing && effectDuration != -1)
