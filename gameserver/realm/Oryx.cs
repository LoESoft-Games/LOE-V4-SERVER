...
namespace gameserver.realm
{
    ...
    internal class Oryx : IDisposable
    {
        ...
        private readonly List<Tuple<string, MapSetPiece>> events = new List<Tuple<string, MapSetPiece>>
        {
            Tuple.Create("Skull Shrine", (MapSetPiece) new SkullShrine()),
            Tuple.Create("Pentaract", (MapSetPiece) new Pentaract()),
            Tuple.Create("Grand Sphinx", (MapSetPiece) new Sphinx()),
